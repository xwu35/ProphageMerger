...
/your/path/to/ProphageMerger/workflow/scripts/combine_prophage_coordinates.py \
     ...
     --cenote_prune path/to/prune_summary.tsv \
     --cenote_virus path/to/virus_summary.tsv \
