...
- **output_dir/results/final_coordinates_0-based.bed**: Same as final_coordinates.txt, but this version has been converted to 0-based coordinates. It can be used directly with [VTPhageFinder](https://github.com/xwu35/VTPhageFinder)
